...
export function getPopupElements() {
  return {
    ...
    createQueueButton: requiredButton('createQueueButton'),
    clearQueueButton: requiredButton('clearQueueButton'),
    queueCount: requiredElement<HTMLSpanElement>('queueCount'),
    queueList: requiredElement<HTMLOListElement>('queueList'),
